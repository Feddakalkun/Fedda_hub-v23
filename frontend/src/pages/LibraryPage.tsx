    ...
    return (
        <div className="flex h-full flex-col overflow-hidden bg-fedda-bg-0">
            <div className="shrink-0 border-b border-white/[0.06] px-6 py-5">
                <div className="text-[10px] font-semibold uppercase tracking-[0.18em] text-fedda-text-4 mb-1">LoRA & Character</div>
                <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <h1 className="text-xl font-semibold text-fedda-text-1">Manage workflow character models</h1>
