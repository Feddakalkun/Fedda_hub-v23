...
export const APP_VERSION_LABEL = 'FEDDA Hub v23';
export const ACTIVE_TAB_STORAGE_KEY = 'fedda_v23_active_tab';
...
export const FEDDA_MODULES: FeddaModule[] = [
  ...
  },
  {
    ...
    label: 'Video Studio',
    description: 'WAN and LTX motion workflows.',
    area: 'home',
    pack: 'booster',
    tabs: ['video'],
    defaultTab: 'video',
  ...
  },
  {
    ...
    description: 'Install, import and manage LoRA character packs.',
    area: 'system',
    pack: 'core',
    tabs: ['library'],
    defaultTab: 'library',
  ...
  },
  {
    ...
    sourceModuleId: 'core-shell',
    label: 'Ollama Models',
    description: 'Download and remove local text and vision models.',
    area: 'system',
    pack: 'core',
    tabs: ['ollama'],
    defaultTab: 'ollama',
  ...
  },
  {
    ...
    sourceModuleId: 'core-shell',
    label: 'Venice.ai',
    description: 'Image generation + Agent chat with web search, vision & tools.',
    area: 'home',
    pack: 'core',
    tabs: ['venice'],
    defaultTab: 'venice',
  ...
  },
  {
    ...
    sourceModuleId: 'core-shell',
    label: 'Grok',
    description: 'Chat and image generation via xAI/SuperGrok.',
    area: 'home',
    pack: 'core',
    tabs: ['grok'],
    defaultTab: 'grok',
  ...
  },
  {
    ...
    sourceModuleId: 'core-shell',
    label: 'Companion',
    description: 'Your persistent AI partner with MemPalace long-term memory.',
    area: 'system',
    pack: 'core',
    tabs: ['companion'],
  ...
  },
  {
    ...
    label: 'Chroma1-HD',
    description: 'Chroma1-HD text-to-image workflow.',
    area: 'image',
    pack: 'booster',
  ...
  },
  {
    ...
    sourceModuleId: 'chroma-image',
    label: 'Chroma Simple',
    description: 'Native Chroma with softer defaults.',
    area: 'image',
    pack: 'booster',
  ...
  },
  {
    ...
    description: 'Rapid AIO v23 image editing.',
    area: 'image',
    pack: 'booster',
  ...
  },
  {
    ...
    description: 'SDXL inpainting with automatic mask generation.',
    area: 'image',
    pack: 'booster',
  ...
  },
  {
    ...
    sourceModuleId: 'sdxl-pack',
    label: 'SDXL OUTPAINT',
    description: 'Extend an image outward with SDXL.',
    area: 'image',
    pack: 'booster',
    tabs: ['sdxl-outpaint'],
  ...
  },
  {
    ...
    description: 'Control 3D depth layers with a depth map.',
    area: 'image',
    pack: 'booster',
  ...
  },
  {
    ...
    description: 'Control character poses using OpenPose skeletons.',
    area: 'image',
    pack: 'booster',
  ...
  },
  {
    ...
    sourceModuleId: 'wan-video',
    label: 'SCAIL-2',
    description: 'Animate a reference photo with dance/pose motion.',
    area: 'video',
    pack: 'booster',
    tabs: ['wan21-scail2'],
